...
public interface KNNVectorValuesIterator {
    ...
    class DocIdsIteratorValues implements KNNVectorValuesIterator {
        ...
        private final KnnVectorValues knnVectorValues; // Added reference to KnnVectorValues
        @Getter
        @Setter
        ...
        DocIdsIteratorValues(final DocIdSetIterator docIdSetIterator, final KnnVectorValues knnVectorValues) {
