...
public final class RescoreContext {
     ...
     * provided by the user. Higher dimensions need less oversampling because quantization error
     * is relatively smaller per-dimension.
     *
     ...
     * is no longer used. This method will be removed in the next major version.
     */
    @Deprecated
