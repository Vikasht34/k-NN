...
public class QuantizationServiceTests extends KNNTestCase {
    ...
    public void testTrain_oneBitQuantizer_success() throws IOException {
        ...
        QuantizationState quantizationState = quantizationService.train(oneBitParams, knnVectorValues, knnVectorValues.get().totalLiveDocs());
    ...
    public void testTrain_twoBitQuantizer_success() throws IOException {
        ...
        QuantizationState quantizationState = quantizationService.train(twoBitParams, knnVectorValues, knnVectorValues.get().totalLiveDocs());
    ...
    public void testTrain_fourBitQuantizer_success() throws IOException {
        ...
        QuantizationState quantizationState = quantizationService.train(fourBitParams, knnVectorValues, knnVectorValues.get().totalLiveDocs());
